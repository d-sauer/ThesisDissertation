...
function doRequest2(method,XML,updateHash,objectName,url) {
    ...
    msgLoader = document.getElementById("msgLoader2");
    if(msgLoader!=null) {
        msgLoader.innerHTML = "<img src=\"images/ajax_msg_loader.gif\" />";
    }
...
function doubleRequest (method,XML,updateHash,objectName,url, objectName2,url2) {
    doRequest2(method, XML, updateHash, objectName, url);
    obj2 = document.getElementById(objectName2);
    obj2.innerHTML=url2;
}
